          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 14 }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 11, color: DotFuelColors.lime, fontWeight: '700', marginTop: 2 }}>
                  STARTS JUNE 23, 2026 • JOIN ANYTIME
                </Text>
              </View>
            </View>
            ...
            <Text style={{
              ...
              Starts on <Text style={{ color: DotFuelColors.lime, fontWeight: 'bold' }}>June 23, 2026</Text> and runs until <Text style={{ color: DotFuelColors.white, fontWeight: 'bold' }}>August 30, 2026</Text>. You can join at any point, but the challenge concludes on August 30.
            </Text>
